	...
	theme: {
		...
		extend: {
			colors: {
				...
				metric: {
					total: 'hsl(var(--metric-total))',
					online: 'hsl(var(--metric-online))',
					offline: 'hsl(var(--metric-offline))',
					never: 'hsl(var(--metric-never))',
					unregister: 'hsl(var(--metric-unregister))'
				},
				chart: {
					'1': 'hsl(var(--chart-1))',
					'2': 'hsl(var(--chart-2))',
